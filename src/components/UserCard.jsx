  ...
  return (
    <div className="flex justify-center items-center min-h-screen p-4">
      <div className="relative group">
        ...
        {/* Main card */}
        <div className="relative card bg-black/60 backdrop-blur-xl w-80 shadow-2xl hover:shadow-purple-500/25 transition-all duration-500 border border-purple-500/30 hover:border-purple-400/50 rounded-3xl overflow-hidden">
          ...
          <figure className="px-6 pt-6 relative z-10">
            <div className="relative">
              <img
                ...
                className="rounded-2xl w-full h-40 object-cover ring-2 ring-purple-400/30 group-hover:ring-purple-400/60 transition-all duration-500"
              />
          ...
          <div className="card-body items-center text-center relative z-10 px-5 pb-5">
            {/* Name with gradient effect */}
            <h2 className="card-title text-xl font-bold bg-gradient-to-r from-purple-300 via-violet-300 to-indigo-300 bg-clip-text text-transparent mb-2 group-hover:from-purple-200 group-hover:via-violet-200 group-hover:to-indigo-200 transition-all duration-500">
            ...
            {userData.skills && userData.skills.length > 0 && (
              <div className="flex flex-wrap gap-2 mt-2 justify-center mb-4">
                {userData.skills.map((skill, index) => (
                  <span
                    key={index}
                    className="px-2 py-1 text-xs font-medium bg-gradient-to-r from-purple-500/20 to-indigo-500/20 text-purple-200 border border-purple-400/30 rounded-full backdrop-blur-sm hover:from-purple-500/30 hover:to-indigo-500/30 hover:border-purple-400/50 transition-all duration-300 cursor-default"
                  >
                    {skill}
                  </span>
                ))}
            ...
            <div className="card-actions justify-center mt-4 gap-3 w-full">
              <button
                ...
                disabled={isLoading}
                className={`btn bg-gradient-to-r from-red-500 to-pink-500 hover:from-red-400 hover:to-pink-400 text-white border-none rounded-2xl px-6 py-2 font-semibold transition-all duration-300 transform hover:scale-105 active:scale-95 shadow-lg hover:shadow-red-500/25 relative overflow-hidden ${
